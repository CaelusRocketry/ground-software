...
const SequencePane = () => (
  <div className="pane">
    ...
    <Timeline>
      <Event interval="Pending" title={"Propellant Loading"}>
        <ol>
          ...
          <ol>
            ...
            <li>
              b. Provide secondary warning when proper amount his reached.
            </li>
          </ol>
      ...
      <Event interval="Pending" title={"Leak Testing Phase 1"}>
        <ol>
      ...
      <Event interval="Pending" title={"Pressurant Loading"}>
        <ol>
          <li>1. Open solenoid valve between N2 tank and ethanol tank</li>
          <li>
            2. Close valve once tank pressure reaches 800 psi (monitor pressure)
          </li>
          <li>3. Open solenoid valve between N2O cylinder and N2O tank</li>
          <li>4. Close valve once tank volume reaches proper amount</li>
        </ol>
      </Event>
      <Event interval="Pending" title={"Leak Testing Phase 2"}>
        <ol>
          <li>1. Leave tanks on test stand for 30 minutes</li>
          <li>2. Ensure neither pressure nor mass decreases for either tank</li>
          <li>
            a. Monitor temperature, pressure, and mass data for any anomalies
          </li>
        </ol>
      </Event>
      <Event interval="Pending" title={"Pre-Ignition"}>
        <ol>
          <li>1. Item 1</li>
          <li>2. Item 2</li>
        </ol>
      </Event>
      <Event interval="Pending" title={"Disconnection"}>
        <ol>
          <li>1. Item 1</li>
          <li>2. Item 2</li>
        </ol>
